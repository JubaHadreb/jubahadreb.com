...
<html lang="fr" xml:lang="fr">
  ...
  <head>
    ...
    <meta name="description" content="Présentation de mes dessins graphiques, illustrations numériques, photos et autres oeuvres artistiques.">
    <meta name="keywords" content="juba hadreb,art,art graphique,oeuvres artistiques,dessins,photos,video">
    <meta name="author" content="Juba Hadreb">
    <title>Juba Hadreb - Oeuvres Artistiques ></title>
  ...
  <body>
      ...
      <div class="row">
        ...
        <nav class="col-12 col-md-10"> 
          <ul>
            ...
            <li><a href="https://jubahadreb.com/Art" class="nav_on">Art</a></li>
    ...
    <main>
      <section id="main_projets" class="container text-center">
        <!--<ul id="main_projets_nav" class="row">
          ...
          <li class="col-3 col-sm-2"><a href="https://jubahadreb.com/pages/art.php" class="main_projets_nav_on">Tout</a></li>
          <li class="col-3 col-sm-2"><a href="https://jubahadreb.com/pages/art.php" class="main_projets_nav_off">Dessins</a></li>
          <li class="col-3 col-sm-2"><a href="https://jubahadreb.com/pages/art.php" class="main_projets_nav_off">Photos</a></li>
          <li class="col-3 col-sm-2"><a href="https://jubahadreb.com/pages/art.php" class="main_projets_nav_off">Video</a></li>
        </ul>-->
        <ul id="main_projets_list" class="row">

          <?php
            $sql = $connexion->query(' SELECT work_id, work_project ,work_page , work_type, work_file FROM works WHERE work_page ="art" ORDER BY work_id DESC LIMIT 0,'.$nmbr);
        ...
        <?php            
          ...
          $sql = $connexion->prepare(' SELECT * FROM works WHERE work_page ="art" ');        
          $sql->execute();          
          $total = $sql->rowCount();

          if($total > $i){
            echo'<a href="https://jubahadreb.com/Art/'.$a.'/'.$nmbr.'" class="plus">En voir plus</a>';
          }
        ?>
      ...
      <section id="Echanges" class="container text-center">
        ...
        <div class="row">
          ...
          <form class="col-12 col-md-5" action="<?php $_SERVER['PHP_SELF'] ?>#Echanges" method="post" onsubmit="return valider();">        
            <table>            
              <tr>
    ...
    <footer class="text-center">
        <a href="https://jubahadreb.com/index.php"><<span>/</span>jubahadreb></a>
    </footer>
